...
export declare namespace RoboticVacuumCleanerRequirements {
     ...
     */
    const RvcOperationalStateServer: import("../index.js").ClusterBehavior.Type<typeof BaseRvcOperationalStateServer, import("@matter/types").ClusterType.WithEnabledAttributes<import("@matter/types").ClusterType.WithEnabledEvents<import("@matter/types/clusters/rvc-operational-state").RvcOperationalState, "operationCompletion">, never>, import("@matter/types").ClusterType.Concrete, new () => {}, "rvcOperationalState">;
    /**
    ...
    const server: {
        mandatory: {
            ...
            RvcOperationalState: import("../index.js").ClusterBehavior.Type<typeof BaseRvcOperationalStateServer, import("@matter/types").ClusterType.WithEnabledAttributes<import("@matter/types").ClusterType.WithEnabledEvents<import("@matter/types/clusters/rvc-operational-state").RvcOperationalState, "operationCompletion">, never>, import("@matter/types").ClusterType.Concrete, new () => {}, "rvcOperationalState">;
        };
        optional: {
...
export declare const RoboticVacuumCleanerDeviceDefinition: MutableEndpoint.With<import("../index.js").EndpointType.For<{
    ...
    readonly behaviors: {
        ...
        readonly rvcOperationalState: import("../index.js").ClusterBehavior.Type<typeof BaseRvcOperationalStateServer, import("@matter/types").ClusterType.WithEnabledAttributes<import("@matter/types").ClusterType.WithEnabledEvents<import("@matter/types/clusters/rvc-operational-state").RvcOperationalState, "operationCompletion">, never>, import("@matter/types").ClusterType.Concrete, new () => {}, "rvcOperationalState">;
    };
}>, {
    readonly identify: typeof BaseIdentifyServer;
} & {
