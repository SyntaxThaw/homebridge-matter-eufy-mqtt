...
export declare namespace OvenRequirements {
    /**
...
export declare const OvenDeviceDefinition: MutableEndpoint.With<import("../index.js").EndpointType.For<{
    readonly name: "Oven";
    readonly deviceType: 123;
    readonly deviceRevision: 2;
    readonly requirements: typeof OvenRequirements;
    readonly behaviors: {};
}>, {}>;
export declare const OvenDevice: OvenDevice;
