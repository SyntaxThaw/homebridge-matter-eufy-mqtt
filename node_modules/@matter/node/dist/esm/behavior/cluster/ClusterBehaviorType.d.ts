 ...
 */
export declare function ClusterBehaviorType({ namespace, base, features, schema, name, forClient, commandFactory, }: ClusterBehaviorType.Configuration): ClusterBehavior.Type<Behavior.Type, import("@matter/types").ClusterTyping, ClusterType.Concrete, new () => {}, Uncapitalize<string>>;
