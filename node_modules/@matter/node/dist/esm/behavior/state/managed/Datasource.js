...
import { ExpiredReferenceError, hasRemoteActor, Val } from "@matter/protocol";
...
class RootReference {
  ...
  change(mutator) {
    ...
    if (this.#values === this.#internals.values) {
      ...
      const properties = this.#values[Val.properties] ? this.#values[Val.properties](this.rootOwner, this.#session) : void 0;
  ...
  #startWrite() {
    ...
    if (hasRemoteActor(this.#session) && !this.#session.interactionStarted && this.#session.interactionComplete && !this.#session.interactionComplete.isObservedBy(this.#internals.interactionObserver)) {
