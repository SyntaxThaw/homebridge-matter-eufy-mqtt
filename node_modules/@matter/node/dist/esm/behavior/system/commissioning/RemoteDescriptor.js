...
((RemoteDescriptor2) => {
  function is(subject, object) {
    ...
    if (object.deviceIdentifier !== void 0 && object.deviceIdentifier !== "") {
  ...
  function toLongForm(descriptor, long = {}) {
    ...
    if (VP !== void 0) {
      ...
      long.vendorId = Number.isFinite(vendor) ? VendorId(vendor, false) : void 0;
    ...
    long.deviceType = DT === void 0 ? void 0 : DeviceTypeId(DT, false);
    long.deviceName = DN;
