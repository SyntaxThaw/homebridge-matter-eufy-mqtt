...
import { PeerAddress, Write, WriteResult } from "@matter/protocol";
...
class OtaAnnouncements {
  ...
  async #announceOtaProvider(peerAddress) {
    ...
    if (existingOtaProviderRecord === void 0 || !isDeepEqual(consideredOtaProviderRecord, existingOtaProviderRecord)) {
      try {
