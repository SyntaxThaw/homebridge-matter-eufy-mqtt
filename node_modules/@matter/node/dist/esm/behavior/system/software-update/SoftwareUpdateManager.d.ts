...
import { Bytes, Duration, EventEmitter, Observable, ObserverGroup, Timer, Timestamp } from "@matter/general";
import { DclOtaUpdateService, FileDesignator, OtaUpdateSource, PeerAddress } from "@matter/protocol";
...
export declare class SoftwareUpdateManager extends Behavior {
    ...
    readonly state: SoftwareUpdateManager.State;
    internal: SoftwareUpdateManager.Internal;
    readonly events: SoftwareUpdateManager.Events;
    initialize(): Promise<void>;
    get storage(): import("@matter/protocol").ScopedStorage;
    /**
     ...
     */
    suppressNextStartUp(peerAddress: PeerAddress, sessionId: number): void;
    /**
...
export declare namespace SoftwareUpdateManager {
    ...
    class Internal {
         ...
         */
        pendingStartUpSuppress: Map<string, number>;
    }
