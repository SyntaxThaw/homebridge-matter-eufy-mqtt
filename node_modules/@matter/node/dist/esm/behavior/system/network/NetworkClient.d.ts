...
import { DatatypeModel } from "@matter/model";
import { ClientSubscription, Subscribe } from "@matter/protocol";
...
export declare class NetworkClient extends NetworkBehavior {
    ...
    readonly state: NetworkClient.State;
    readonly events: NetworkClient.Events;
    initialize(): void;
