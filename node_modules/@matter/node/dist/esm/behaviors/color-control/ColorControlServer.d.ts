...
declare const ColorControlBase: import("../../index.js").ClusterBehavior.Type<import("./ColorControlBehavior.js").ColorControlBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<ColorControl, {
    hueSaturation: true;
    enhancedHue: true;
    colorLoop: true;
    xy: true;
    colorTemperature: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "colorControl">;
/**
...
export declare class ColorControlBaseServer extends ColorControlBase {
    ...
    readonly state: ColorControlBaseServer.State;
    readonly events: ColorControlBaseServer.Events;
...
export declare namespace ColorControlBaseServer {
    ...
    class State extends ColorControlBase.State {
        ...
        colorLoopActive: ColorControl.ColorLoopActive;
        colorLoopDirection: ColorControl.ColorLoopDirection;
...
declare const ColorControlServer_base: import("../../index.js").ClusterBehavior.Type<typeof ColorControlBaseServer, ColorControl, typeof ColorControl, typeof ColorControlBaseServer.Internal, "colorControl"> & {
    readonly id: "colorControl";
};
