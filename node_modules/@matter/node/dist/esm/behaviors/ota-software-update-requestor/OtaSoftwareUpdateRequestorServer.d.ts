 ...
 */
import { AsyncObservable, Bytes, CancelablePromise, Duration, MaybePromise, Timer } from "@matter/general";
import { OtaImageHeader, PersistedFileDesignator } from "@matter/protocol";
...
export declare class OtaSoftwareUpdateRequestorServer extends OtaSoftwareUpdateRequestorBehavior {
    ...
    readonly state: OtaSoftwareUpdateRequestorServer.State;
    readonly events: OtaSoftwareUpdateRequestorServer.Events;
    static readonly schema: import("@matter/model").ClusterModel;
    initialize(): Promise<void>;
    getDownloadLocation(): Promise<PersistedFileDesignator>;
    /**
