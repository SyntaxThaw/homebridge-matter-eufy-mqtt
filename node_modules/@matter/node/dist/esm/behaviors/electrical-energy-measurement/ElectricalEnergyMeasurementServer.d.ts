...
declare const ElectricalEnergyMeasurementBase: import("../../index.js").ClusterBehavior.Type<import("./ElectricalEnergyMeasurementBehavior.js").ElectricalEnergyMeasurementBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<ElectricalEnergyMeasurement, {
    importedEnergy: true;
    exportedEnergy: true;
    cumulativeEnergy: true;
    periodicEnergy: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "electricalEnergyMeasurement">;
/**
...
declare const ElectricalEnergyMeasurementServer_base: import("../../index.js").ClusterBehavior.Type<typeof ElectricalEnergyMeasurementBaseServer, ElectricalEnergyMeasurement, typeof ElectricalEnergyMeasurement, new () => {}, "electricalEnergyMeasurement"> & {
    readonly id: "electricalEnergyMeasurement";
};
