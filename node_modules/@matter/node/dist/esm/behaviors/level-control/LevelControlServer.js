...
import { AsyncObservable, cropValueRange, Logger, MaybePromise, Millis } from "@matter/general";
...
class LevelControlBaseServer extends LevelControlBase {
  ...
  initializeLighting() {
    ...
    if (this.#getBootReason() !== GeneralDiagnostics.BootReason.SoftwareUpdateCompleted && !this.endpoint.ownerOfType(AggregatorEndpoint)) {
...
class LevelControlServer extends LevelControlBaseServer.for(LevelControl) {
}
