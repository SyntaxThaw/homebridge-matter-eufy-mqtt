...
const AlarmCode = DoorLock.AlarmCode;
const CredentialRule = DoorLock.CredentialRule;
const CredentialType = DoorLock.CredentialType;
const DoorState = DoorLock.DoorState;
const LockOperationType = DoorLock.LockOperationType;
const LockState = DoorLock.LockState;
const OperationError = DoorLock.OperationError;
const OperationSource = DoorLock.OperationSource;
const UserStatus = DoorLock.UserStatus;
const UserType = DoorLock.UserType;
...
((NonUserDoorLockServer2) => {
  ...
  class State extends (_a = NonUserBase.State, _users_dec = [field(listOf(LockAuth.User), nonvolatile)], _credentials_dec = [field(listOf(LockAuth.Credential), nonvolatile)], _weekDaySchedules_dec = [field(listOf(LockSchedule.WeekDay), nonvolatile)], _yearDaySchedules_dec = [field(listOf(LockSchedule.YearDay), nonvolatile)], _holidaySchedules_dec = [field(listOf(LockSchedule.Holiday), nonvolatile)], _credentialKey_dec = [field(octstr, nonvolatile)], _a) {
    constructor() {
      super(...arguments);
