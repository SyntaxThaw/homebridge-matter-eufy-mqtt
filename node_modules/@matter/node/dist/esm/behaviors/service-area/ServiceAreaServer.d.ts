...
declare const ServiceAreaBase: import("../../index.js").ClusterBehavior.Type<import("./ServiceAreaBehavior.js").ServiceAreaBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<ServiceArea, {
    selectWhileRunning: false;
    progressReporting: true;
    maps: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "serviceArea">;
...
declare const ServiceAreaServer_base: import("../../index.js").ClusterBehavior.Type<typeof ServiceAreaBaseServer, import("@matter/types").ClusterType.WithSupportedFeatures<import("@matter/types").ClusterType.WithSupportedFeatures<ServiceArea, {
    selectWhileRunning: false;
    progressReporting: true;
    maps: true;
}>, {
