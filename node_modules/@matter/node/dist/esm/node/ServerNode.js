...
import { asyncNew, Construction, DiagnosticSource, errorOf, MatterError } from "@matter/general";
import {
  FabricManager,
  OccurrenceManager,
  PeerSet,
...
class ServerNode extends Node {
  ...
  constructor(definition, options) {
    const config = Node.nodeConfigFor(ServerNode.RootEndpoint, definition, options ?? {});
    super(config);
