...
import { OccurrenceManager, PeerAddress, PeerSet } from "@matter/protocol";
...
class ClientNode extends Node {
  ...
  get peerAddress() {
    let address = PeerAddress(this.behaviors.maybeStateOf("commissioning")?.peerAddress);
    if (!address) {
      address = PeerAddress(this.store.storeForEndpoint(this).peerAddress);
    }
    return address;
  }
  get identity() {
