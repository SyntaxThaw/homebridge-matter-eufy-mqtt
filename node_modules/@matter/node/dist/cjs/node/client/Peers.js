...
var import_PaseDiscovery = require("#behavior/system/controller/discovery/PaseDiscovery.js");
...
class Peers extends import_EndpointContainer.EndpointContainer {
   ...
   */
  pase(options) {
    return new import_PaseDiscovery.PaseDiscovery(this.owner, options);
  }
  /**
   ...
   */
  async forDescriptor(descriptor) {
    const factory = this.owner.env.get(import_ClientNodeFactory.ClientNodeFactory);
  ...
  async #onStartUp(node) {
    ...
    const sessionManager = this.owner.env.get(import_protocol.SessionManager);
