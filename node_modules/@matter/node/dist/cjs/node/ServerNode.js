...
class ServerNode extends import_Node.Node {
  ...
  constructor(definition, options) {
    const config = import_Node.Node.nodeConfigFor(ServerNode.RootEndpoint, definition, options ?? {});
    super(config);
    this.#plugins = new import_Plugins.Plugins(this);
  ...
  async prepareRuntimeShutdown() {
    await this.env.maybeGet(import_protocol.PeerSet)?.disconnect();
...
((ServerNode2) => {
  ServerNode2.RootEndpoint = import_root.RootEndpoint.with(
    ...
    import_SubscriptionsServer.SubscriptionsServer,
