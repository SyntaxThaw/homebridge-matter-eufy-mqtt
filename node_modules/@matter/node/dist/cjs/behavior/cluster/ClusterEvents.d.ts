 ...
 */
export type ClusterEvents<N extends ClusterTyping = ClusterTyping, BaseT extends Behavior.Type = Behavior.Type> = Omit<InstanceType<BaseT["Events"]>, keyof ClusterEvents.Properties<N>> & ClusterEvents.Properties<N>;
export declare namespace ClusterEvents {
     ...
     */
    export type Properties<N extends ClusterTyping = ClusterTyping> = ChangingObservables<N> & ChangedObservables<N> & EventObservables<N>;
    /**
    ...
    ] ? (S extends C["flags"] ? (C extends {
        attributes: infer A;
    } ? RequiredKeysOf<A> : never) : never) | MandatoryAttrKeys<R, S> : never;
    /**
    ...
    type ApplicableAttrKeys<CA extends ClusterType.Component[], S> = CA extends [
        ...
        attributes: infer A;
    } ? keyof A & string : never) : never) | ApplicableAttrKeys<R, S> : never;
    /**
     * Optional = applicable keys minus mandatory.
     */
    type OptionalAttrKeys<CA extends ClusterType.Component[], S> = Exclude<ApplicableAttrKeys<CA, S>, MandatoryAttrKeys<CA, S>>;
    /**
     * Produce changing observables from applicable attributes.
     */
    type ChangingObservables<N extends ClusterTyping> = N extends {
        Attributes: infer A;
    } ? {
        [K in MandatoryAttrKeys<ComponentsOf<N>, ClusterType.SupportedFeaturesOf<N>> & keyof A as `${K & string}$Changing`]: ChangingObservable<A[K]>;
    } & {
        [K in OptionalAttrKeys<ComponentsOf<N>, ClusterType.SupportedFeaturesOf<N>> & keyof A as `${K & string}$Changing`]?: ChangingObservable<A[K]>;
    } : {};
    /**
     * Produce changed observables from applicable attributes.
     */
    type ChangedObservables<N extends ClusterTyping> = N extends {
        Attributes: infer A;
    } ? {
        [K in MandatoryAttrKeys<ComponentsOf<N>, ClusterType.SupportedFeaturesOf<N>> & keyof A as `${K & string}$Changed`]: ChangedObservable<A[K]>;
    } & {
        [K in OptionalAttrKeys<ComponentsOf<N>, ClusterType.SupportedFeaturesOf<N>> & keyof A as `${K & string}$Changed`]?: ChangedObservable<A[K]>;
    } : {};
    /**
     ...
     */
    type EventObservables<N extends ClusterTyping> = N extends {
        Events: infer E;
    ...
    type AllAttrKeys<CA extends ClusterType.Component[]> = CA extends [
        ...
        attributes: infer A;
    } ? keyof A & string : never) | AllAttrKeys<R> : never;
    /**
     ...
     */
    export type Complete<N extends ClusterTyping = ClusterTyping, B extends Behavior.Type = Behavior.Type> = Omit<InstanceType<B["Events"]>, keyof Properties<N>> & CompleteProperties<N>;
    /**
     * Complete properties: all attribute change observables + all event observables, all mandatory.
     */
    type CompleteProperties<N extends ClusterTyping> = CompleteChangingObservables<N> & CompleteChangedObservables<N> & CompleteEventObservables<N>;
    /**
     * All changing observables from all components, all mandatory.
     */
    type CompleteChangingObservables<N extends ClusterTyping> = N extends {
        Attributes: infer A;
    } ? {
        [K in AllAttrKeys<ClusterType.ComponentsOf<N>> & keyof A as `${K & string}$Changing`]: ChangingObservable<A[K]>;
    } : {};
    /**
     * All changed observables from all components, all mandatory.
     */
    type CompleteChangedObservables<N extends ClusterTyping> = N extends {
        Attributes: infer A;
    } ? {
        [K in AllAttrKeys<ClusterType.ComponentsOf<N>> & keyof A as `${K & string}$Changed`]: ChangedObservable<A[K]>;
    } : {};
    /**
     * All event observables from all components, all mandatory.
     */
    type CompleteEventObservables<N extends ClusterTyping> = N extends {
        Events: infer E;
    } ? {
