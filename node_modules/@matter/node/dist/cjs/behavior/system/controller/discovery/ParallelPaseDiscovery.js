...
const PASE_STAGGER_DELAY = (0, import_general.Seconds)(5);
class ParallelPaseDiscovery extends import_Discovery.Discovery {
  ...
  registerAttempt(factory, extractWinner) {
    ...
    const stagger = (0, import_general.Millis)(attemptIndex * PASE_STAGGER_DELAY);
    const startFactory = () => {
      this.#startedCount++;
