...
export declare namespace CastingVideoPlayerRequirements {
     ...
     */
    const ApplicationLauncherServer: import("../index.js").ClusterBehavior.Type<typeof BaseApplicationLauncherServer, import("@matter/types").ClusterType.WithSupportedFeatures<import("@matter/types/clusters/application-launcher").ApplicationLauncher, {
        applicationPlatform: true;
    }>, import("@matter/types").ClusterType.Concrete, new () => {}, "applicationLauncher">;
    /**
    ...
    const server: {
        ...
        optional: {
            ...
            ApplicationLauncher: import("../index.js").ClusterBehavior.Type<typeof BaseApplicationLauncherServer, import("@matter/types").ClusterType.WithSupportedFeatures<import("@matter/types/clusters/application-launcher").ApplicationLauncher, {
                applicationPlatform: true;
            }>, import("@matter/types").ClusterType.Concrete, new () => {}, "applicationLauncher">;
