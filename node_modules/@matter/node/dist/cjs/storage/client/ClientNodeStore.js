...
var import_LocalWriter = require("./LocalWriter.js");
/**
 * @license
...
class ClientNodeStore extends import_NodeStore.NodeStore {
  ...
  #isPreexisting;
  #onErase;
  constructor(id, storage, isPreexisting, onErase) {
    super(storage);
    this.#id = id;
  ...
  get localWriter() {
    if (this.#localWriter === void 0) {
      this.#localWriter = new import_LocalWriter.LocalWriter(this);
    }
  ...
  storeForEndpointNumber(endpointNumber) {
    const store = this.#stores.get(endpointNumber);
    if (store === void 0) {
      throw new import_general.InternalError(`No endpoint store for endpoint ${endpointNumber}`);
    }
    return store;
  }
  async erase() {
