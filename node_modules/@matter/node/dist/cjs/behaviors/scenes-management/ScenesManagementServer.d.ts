...
import { BasicSet, MaybePromise, ObserverGroup } from "@matter/general";
import { Val } from "@matter/protocol";
import { AttributeId, ClusterId, FabricIndex, GroupId, TlvSchema } from "@matter/types";
...
declare const ScenesManagementBase: ClusterBehavior.Type<ClusterBehavior.Type<import("./ScenesManagementBehavior.js").ScenesManagementBehaviorConstructor, ScenesManagement, typeof ScenesManagement, new () => {}, "scenesManagement"> & {
    readonly id: "scenesManagement";
}, import("@matter/types").ClusterType.WithSupportedFeatures<ScenesManagement, {
    sceneNames: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "scenesManagement">;
/**
...
export declare class ScenesManagementServer extends ScenesManagementBase {
    #private;
    readonly state: ScenesManagementServer.State;
