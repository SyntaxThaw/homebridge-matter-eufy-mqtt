...
declare const WindowCoveringBase: import("../../index.js").ClusterBehavior.Type<import("./WindowCoveringBehavior.js").WindowCoveringBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<WindowCovering, {
    lift: true;
    tilt: true;
    positionAwareLift: true;
    absolutePosition: false;
    positionAwareTilt: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "windowCovering">;
...
export declare class WindowCoveringBaseServer extends WindowCoveringBase {
    ...
    readonly state: WindowCoveringBaseServer.State;
     ...
     * @protected
     */
    protected handleMovement(type: MovementType, reversed: boolean, direction: MovementDirection, targetPercent100ths?: number): MaybePromise;
    /**
...
export declare namespace WindowCoveringBaseServer {
    ...
    const ExtensionInterface: {
        handleMovement(type: MovementType, reversed: boolean, direction: MovementDirection, targetPercent100ths?: number): MaybePromise;
        handleStopMovement(): MaybePromise;
        executeCalibration(): MaybePromise;
    };
}
declare const WindowCoveringServer_base: import("../../index.js").ClusterBehavior.Type<typeof WindowCoveringBaseServer, WindowCovering, typeof WindowCovering, typeof WindowCoveringBaseServer.Internal, "windowCovering"> & {
    readonly id: "windowCovering";
};
