...
var import_groups = require("@matter/types/clusters/groups");
...
const { commands } = import_groups.Groups.schema;
const addGroup = commands.require("AddGroup");
const addGroupIfIdentifying = commands.require("AddGroupIfIdentifying");
const GroupsSchema = import_groups.Groups.schema.extend(
  void 0,
  addGroup.extend(void 0, addGroup.fields.extend("GroupName", { constraint: "none" })),
  addGroupIfIdentifying.extend(void 0, addGroupIfIdentifying.fields.extend("GroupName", { constraint: "none" }))
);
const GroupsBase = import_GroupsBehavior.GroupsBehavior.for(import_groups.Groups, GroupsSchema).with(import_groups.Groups.Feature.GroupNames);
