...
import { Bytes, Duration, MaybePromise, Timer } from "@matter/general";
import { Val } from "@matter/protocol";
import { GeneralDiagnostics } from "@matter/types/clusters/general-diagnostics";
declare const Base: import("../../index.js").ClusterBehavior.Type<import("./GeneralDiagnosticsBehavior.js").GeneralDiagnosticsBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<GeneralDiagnostics, {
    dataModelTest: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "generalDiagnostics">;
/**
...
export declare class GeneralDiagnosticsServer extends Base {
    ...
    readonly state: GeneralDiagnosticsServer.State;
...
export declare namespace GeneralDiagnosticsServer {
    class Internal {
        ...
        lastTotalOperationalHoursCounterUpdateTime: import("@matter/general").Timestamp;
    ...
    class State extends Base.State {
        ...
        totalOperationalHoursCounter: Duration;
