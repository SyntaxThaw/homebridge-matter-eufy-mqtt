...
declare const Base: import("../../index.js").ClusterBehavior.Type<import("./BasicInformationBehavior.js").BasicInformationBehaviorConstructor, import("@matter/types").ClusterType.WithEnabledAttributes<import("@matter/types").ClusterType.WithEnabledEvents<BasicInformation, "startUp" | "shutDown" | "leave">, never>, import("@matter/types").ClusterType.Concrete, new () => {}, "basicInformation">;
/**
