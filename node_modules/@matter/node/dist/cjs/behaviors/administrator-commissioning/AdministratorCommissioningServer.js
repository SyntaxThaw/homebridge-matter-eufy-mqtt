...
var import_administrator_commissioning = require("@matter/types/clusters/administrator-commissioning");
 ...
 */
const openCommissioningWindow = import_administrator_commissioning.AdministratorCommissioning.schema.commands.require("OpenCommissioningWindow");
const AdministratorCommissioningSchema = import_administrator_commissioning.AdministratorCommissioning.schema.extend(
  void 0,
...
const AdministratorCommissioningBase = import_AdministratorCommissioningBehavior.AdministratorCommissioningBehavior.for(
  import_administrator_commissioning.AdministratorCommissioning,
  AdministratorCommissioningSchema
);
const logger = import_general.Logger.get("AdministratorCommissioningServer");
class AdministratorCommissioningServer extends AdministratorCommissioningBase {
...
((AdministratorCommissioningServer2) => {
  ...
  class State extends AdministratorCommissioningBase.State {
