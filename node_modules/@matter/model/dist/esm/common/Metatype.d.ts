 ...
 */
import { Bytes, Duration, UnexpectedDataError } from "@matter/general";
...
export declare namespace Metatype {
    ...
    namespace cast {
        ...
        export var bytes: (value: any) => Bytes | null | undefined;
        ...
        export var duration: (value: any) => Duration | null | undefined;
        export { _a as enum };
    }
    /**
