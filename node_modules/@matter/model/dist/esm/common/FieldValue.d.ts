 ...
 */
export type FieldValue = null | string | number | bigint | boolean | Date | Duration | FieldValue[] | FieldValue.Properties | FieldValue.Reference | FieldValue.Percent | FieldValue.Celsius | FieldValue.Bytes | FieldValue.None;
/**
...
export declare namespace FieldValue {
    ...
    function Bytes(value: AllowSharedBufferSource | string): Bytes;
    /**
