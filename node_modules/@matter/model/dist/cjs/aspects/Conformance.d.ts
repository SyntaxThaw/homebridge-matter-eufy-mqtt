...
export declare class Conformance extends Aspect<Conformance.Definition> {
    ast: Conformance.Ast;
    get type(): Conformance.Special | Conformance.Flag | Conformance.Operator;
    /**
    ...
    extend(other: Conformance): Conformance;
    validateReferences(errorTarget: Conformance.ErrorTarget, lookup: Conformance.ReferenceResolver): void;
    validateComputation(errorTarget: Conformance.ErrorTarget, features?: FeatureSet): void;
    /**
     ...
     */
    applicabilityFor({ definedFeatures: features, supportedFeatures }: Conformance.FeatureContext): Conformance.Applicability;
    toString(): string;
...
export declare namespace Conformance {
    ...
    type AstParam = Ast.Name | Ast.Value | Ast.Option | Ast.UnaryOperand | Ast.BinaryOperands | Ast.Otherwise | Ast.Choice;
    type Ast = {
        ...
        type: Operator.AND | Operator.OR | Operator.XOR | Operator.DOT | Operator.EQ | Operator.NE | Operator.LT | Operator.GT | Operator.LTE | Operator.GTE;
    ...
    type ReferenceResolver = (name: string | string[]) => Model | undefined;
    type ErrorTarget = {
 ...
 */
export declare function collectDotSegments(ast: Conformance.Ast): string[] | undefined;
