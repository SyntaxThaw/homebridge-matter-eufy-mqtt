 ...
 */
export declare function Children<T extends Model = Model>(initial: Children.InputIterable<T>, position: ModelTreePosition): InternalChildren<T>;
export declare namespace Children {
    var installModelConstructor: (constructor: typeof Model) => typeof Model;
}
export declare namespace Children {
    /**
     ...
     */
    type InputIterable<T extends Model> = Iterable<Model.TaggedDefinition<T>>;
}
