...
class DataModelPath {
  ...
  get [import_general.Diagnostic.value]() {
    ...
    for (const segment of this.toArray()) {
      ...
      result.push(import_general.Diagnostic.strong(segment));
    }
    return import_general.Diagnostic.squash(result);
  }
  at(id, type) {
