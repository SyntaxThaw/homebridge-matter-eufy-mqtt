 ...
 */
import { Construction, MaybePromise, Observable } from "@matter/general";
import { EventNumber, FabricIndex, Priority, TlvEventFilter, TlvEventPath, TypeFromSchema } from "@matter/types";
...
export declare class OccurrenceManager {
    ...
    get(eventMin?: EventNumber): AsyncGenerator<{
        number: EventNumber;
        endpointId: import("@matter/types").EndpointNumber;
        clusterId: import("@matter/types").ClusterId;
        eventId: import("@matter/types").EventId;
        epochTimestamp: import("@matter/general").Timestamp;
        priority: Priority;
        payload: unknown;
    }, void, unknown>;
