...
import { BasicMap, Bytes, StorageContext } from "@matter/general";
import { GroupId } from "@matter/types";
export declare const GROUP_SECURITY_INFO: AllowSharedBufferSource;
export declare const IPK_DEFAULT_EPOCH_START_TIME: bigint;
/**
...
export declare class FabricGroups {
    ...
    get endpoints(): Map<GroupId, import("@matter/types").EndpointNumber[]>;
    currentKeyForGroup(groupId: GroupId): {
        keySetId: number;
        key: Bytes;
        sessionId?: number;
        startTime: import("@matter/general").Timestamp;
    };
