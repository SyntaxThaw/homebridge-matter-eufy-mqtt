...
class MessageExchange {
  ...
  async send(messageType, payload, options = {}) {
    ...
    try {
      ...
      if (this.#messageReceivedCounter === 0 && causedBy(e, TransientPeerCommunicationError, TimeoutError, NetworkError)) {
