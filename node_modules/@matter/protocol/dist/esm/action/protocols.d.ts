...
import type { AttributeId, ClusterId, CommandId, DeviceTypeId, EndpointNumber, FabricIndex, NodeId, TlvSchema } from "@matter/types";
...
export type CommandInvokeHandler = (args: Val.Struct | undefined, session: InteractionSession) => MaybePromise<Val.Struct | void>;
/**
...
export declare namespace NodeProtocol {
    type AttrChange = [
 ...
 */
export interface EndpointProtocol extends CollectionProtocol<ClusterProtocol>, AddressableElementProtocol<EndpointNumber> {
    /**
