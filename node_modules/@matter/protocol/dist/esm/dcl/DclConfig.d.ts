...
export declare namespace DclGithubConfig {
    /** Default GitHub PAA certificate repository (project-chip/connectedhomeip) */
    const defaults: DclGithubConfig;
}
//# sourceMappingURL=DclConfig.d.ts.map