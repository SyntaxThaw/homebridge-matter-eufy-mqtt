 ...
 */
import { AddressLifespan, BasicSet, ChannelType, Duration, Environment, Environmental, ServerAddress, ServerAddressUdp } from "@matter/general";
...
export declare function DiscoveryData(kvs: Map<string, string>): DiscoveryData;
/**
