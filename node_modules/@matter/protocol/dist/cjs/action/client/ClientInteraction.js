...
class ClientInteraction {
  ...
  async probe(options) {
    ...
    try {
      await messenger.sendReadRequest((0, import_Read.Read)({ fabricFilter: false }), { abort });
      ...
      if (abort.aborted) {
        logger.debug(
          ...
          messenger.exchange.via,
          messenger.exchange.diagnostics,
          import_general.Diagnostic.weak("(aborted)")
        );
      } else {
        logger.info(
          "Probe",
  ...
  async #executeBatch(commands) {
    try {
      ...
      const batchRequest = {
        ...(0, import_Invoke.Invoke)({ commands: invokeRequests, skipValidation: true }),
