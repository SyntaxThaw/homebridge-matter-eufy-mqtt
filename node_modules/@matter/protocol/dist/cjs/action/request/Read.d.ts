...
export declare namespace Read {
    ...
    function containsAttribute(request: Read): request is Attributes;
    interface Events extends Read {
        eventRequests: Exclude<Read["eventRequests"], undefined>;
    }
    function containsEvent(request: Read): request is Events;
    /**
    ...
    function Attribute<const C extends Specifier.ClusterLike>(selector?: AttributeSelector<C>): {
        kind: "attribute";
    } & AttributeSelector<C>;
    ...
    type GlobalAttributeSpecifier = ClusterType.Attribute | Specifier.GlobalAttributeName;
