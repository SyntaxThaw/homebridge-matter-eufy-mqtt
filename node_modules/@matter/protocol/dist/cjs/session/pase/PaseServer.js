...
const PASE_PAIRING_TIMEOUT = (0, import_general.Seconds)(60);
...
class PaseServer {
  ...
  static fromVerificationValue(sessions, verificationValue, pbkdfParameters) {
    ...
    const w0 = import_general.Bytes.asBigInt(verificationData.slice(0, 32));
  ...
  async onNewExchange(exchange) {
    ...
    if (paseSession !== void 0 && !paseSession.isClosing) {
      ...
      try {
        ...
        const sendError = !(0, import_general.causedBy)(error, import_SecureChannelMessenger.ChannelStatusResponseError);
