...
class NodeSession extends import_SecureSession.SecureSession {
  ...
  async handlePeerClose(currentExchange) {
    this.#isPeerLost = true;
    await this.#closedByPeer.emit(true);
    await this.handlePeerLoss({ cause: new import_PeerCommunicationError.PeerInitiatedCloseError(), currentExchange });
  }
  async handlePeerLoss(context) {
    this.#isPeerLost = true;
  ...
  async initiateForceClose(context) {
    this.#isPeerLost = true;
