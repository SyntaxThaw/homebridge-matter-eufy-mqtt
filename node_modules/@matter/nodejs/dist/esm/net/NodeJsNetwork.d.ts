 ...
 */
import { Network, NetworkInterface, NetworkInterfaceDetails, UdpChannel, UdpChannelOptions } from "@matter/general";
export declare class NodeJsNetwork extends Network {
    static getMulticastInterfaceIpv4(netInterface: string): string | undefined;
    static getMembershipMulticastInterfaces(netInterfaceOrZone: string | undefined, ipv4: boolean): (string | undefined)[];
