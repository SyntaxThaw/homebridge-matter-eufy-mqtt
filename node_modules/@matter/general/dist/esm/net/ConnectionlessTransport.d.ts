...
export declare namespace ConnectionlessTransport {
    ...
    interface Provider<T extends ConnectionlessTransport = ConnectionlessTransport> {
        /**
 ...
 */
export declare class ConnectionlessTransportSet<T extends ConnectionlessTransport = ConnectionlessTransport> extends BasicSet<T> implements ConnectionlessTransport.Provider<T> {
