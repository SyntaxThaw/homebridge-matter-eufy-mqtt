...
export declare class MatterError extends Error {
     ...
     */
    static of<T extends MatterError>(this: {
        new (...args: any[]): T;
        of: typeof MatterError.of;
 ...
 */
export declare class ImportError extends MatterError {
}
/**
...
export declare class MatterAggregateError extends AggregateError {
     ...
     */
    static allSettled<T = unknown>(promises: Iterable<MaybePromise<T>>, message?: string): Promise<T[]>;
    format: (format?: "plain" | "ansi" | "html", indents?: number) => string;
}
/**
