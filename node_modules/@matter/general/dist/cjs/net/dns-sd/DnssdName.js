...
class DnssdName extends import_Observable.BasicObservable {
  ...
  installRecord(record, installedAt) {
    ...
    const at = installedAt ?? import_Time.Time.nowMs;
