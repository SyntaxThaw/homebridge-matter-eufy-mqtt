...
export declare const ec: {
    ...
    abytes: <T extends utils.TArg<Uint8Array>>(value: T, length?: number, title? /**
    ...
    concatBytes: (...arrays: utils.TArg<Uint8Array[]>) => utils.TRet<Uint8Array>;
    hexToBytes: (hex: string) => utils.TRet<Uint8Array>;
    isBytes: typeof import("@noble/hashes/utils.js").isBytes;
    randomBytes: (bytesLength?: number) => utils.TRet<Uint8Array>;
