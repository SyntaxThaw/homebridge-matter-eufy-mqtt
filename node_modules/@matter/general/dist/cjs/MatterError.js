...
class MatterError extends Error {
  ...
  static of(error) {
    ...
    const e = (0, import_Error.asError)(error);
    if (e.cause) {
...
class ImportError extends MatterError {
}
...
class ClosedError extends CanceledError {
  constructor(message = "Component closed", options) {
    super(message, options);
  }
}
...
(0, import_NodeJsStyleInspectable.NodeJsStyleInspectable)(MatterError.prototype, inspector);
(0, import_NodeJsStyleInspectable.NodeJsStyleInspectable)(MatterAggregateError.prototype, inspector);
